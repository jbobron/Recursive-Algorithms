...
(function() {
  ...
  _.uniq = function(array) {
      ...
      _.filter(array, function(value, index, list){
  ...
  _.zip = function() {
    var result = [];
    var lengthOfLongestArg = arguments[0].length;
    for(var i = 0; i<arguments.length-1; i++){
      if(arguments[i+1].length > arguments[i].length){
        lengthOfLongestArg = arguments[i+1].length;
      }
    }

    for(var i = 0; i<lengthOfLongestArg; i++){
      result[i] = [];
  ...
  _.throttle = function(func, wait) {
    ...
    //Array.prototype.slice(this, arguments);
    release();
